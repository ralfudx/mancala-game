...
public class CustomInst extends JPanel implements MouseListener{
    ...
    public static volatile boolean fromGame;
    ...
    public void paintComponent(Graphics udx){
        ...
        String writeDown;
        if(CustomMenu.pStyleL2.getText()!="ANTICLOCKWISE"){
            writeDown = "clockwise";
        }else{
            writeDown = "counterclockwise";
        }
        textLabel.setText("<html><p></p><p align = \"justify\">The object of the game is to collect as many seeds "
                ...
                + "them in a " + writeDown + " direction to the next pit. In this variant, you start with "+ seeds + " seeds</p>"
                ...
                + "and there are some seeds in the opposite pit on your opponents side, you capture "
                + "all the seeds in the two pits and place them in your mancala.</p>"
